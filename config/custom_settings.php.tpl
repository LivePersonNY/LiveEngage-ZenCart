 ...
 */
$zc_settings['http_server_catalog'] = 'http://<% hostname %>';
/**
 ...
 */
$zc_settings['https_server_catalog'] = 'https://<% hostname %>';
/**
 ...
 */
$zc_settings['enable_ssl_catalog'] = 'false';
/**
 ...
 */
$zc_settings['http_server_admin'] = 'http://<% hostname %>';
/**
 ...
 */
$zc_settings['adminDir'] = '<% admin_folder %>';